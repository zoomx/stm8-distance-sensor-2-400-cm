...
3945                     ; 1219     TIM2->CCER1 &= (uint8_t)(~TIM2_CCER1_CC1E);
3947  0001 7211530a      	bres	21258,#0
3948  0005 88            	push	a
...
4040       00000001      OFST:	set	1
4043                     ; 1260     TIM2->CCER1 &= (uint8_t)(~TIM2_CCER1_CC2E);
4045  0001 7219530a      	bres	21258,#4
4046  0005 88            	push	a
...
4141                     ; 1300     TIM2->CCER2 &=  (uint8_t)(~TIM2_CCER2_CC3E);
4143  0001 7211530b      	bres	21259,#0
4144  0005 88            	push	a
