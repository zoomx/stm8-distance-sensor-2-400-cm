...
void Config()
{
  ...
  TIM1->CCER1 |= 0x01;  /* CC1E: Capture/compare 1 output enable, This bit determines if a capture of the counter value can be made in the input capture/compare This bit determines if a capture of the counter value can be made in the input capture/compare */
